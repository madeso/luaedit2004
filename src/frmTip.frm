...
' Name of tips file
Const TIP_FILE = "TIPOFDAY.TIP"

' Index in collection of tip currently being displayed.
Dim CurrentTip As Long

'if true the form shows the tip no matter what the reg says
Public forceTipToShow As Boolean
...
Public Function showAtStartup() As Long
...
Private Sub Form_Load()
    ...
    showAtStartup = GetSetting(App.title, "Options", "Show Tips at Startup", 1)
    If showAtStartup = 0 And Not forceTipToShow Then
        Unload Me
        Exit Sub
    End If
    ...
    ' Seed Rnd
    'Randomize
    'this done in the main form so we don't need to do it here
